...
export class News extends Component {
  ...
  async updateNews() {
    // let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=cd507480f5e3479d8631c653496c6df8&page=${this.state.page}&pageSize=${this.props.pageSize}`;
    // {
    //   this.setState({ loading: true });
    // }
    // let data = await fetch(url);
